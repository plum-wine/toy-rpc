...
public final class RpcSystemConfig {
    ...
    public static final boolean SYSTEM_PROPERTY_JMX_METRICS_HASH_SUPPORT = SYSTEM_PROPERTY_JMX_METRICS_HASH_NUMS != 1;

    public static final boolean SYSTEM_PROPERTY_JMX_METRICS_SUPPORT = SYSTEM_PROPERTY_JMX_INVOKE_METRICS != 0;
